...
var file_tutors_proto_rawDesc = string([]byte{
	...
	0x72, 0x73, 0x32, 0xf1, 0x01, 0x0a, 0x0c, 0x50, 0x6f, 0x73, 0x74, 0x73, 0x53, 0x65, 0x72, 0x76,
...
var file_tutors_proto_depIdxs = []int32{
	...
	4, // 2: users.PostsService.GetUserById:input_type -> users.GetById
	3, // 3: users.PostsService.GetUserByTelegramId:input_type -> users.GetByTelegramId
	5, // 4: users.PostsService.GetAllUsers:input_type -> users.GetAllRequest
	2, // 5: users.PostsService.CreateUser:output_type -> users.CreateResponse
	0, // 6: users.PostsService.GetUserById:output_type -> users.User
	0, // 7: users.PostsService.GetUserByTelegramId:output_type -> users.User
	6, // 8: users.PostsService.GetAllUsers:output_type -> users.GetAllResponse
