...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.BanUser = channel.unary_unary(
                ...
                request_serializer=gRPC_dot_tutors__pb2.BanUserRequest.SerializeToString,
                response_deserializer=gRPC_dot_tutors__pb2.Success.FromString,
                )
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'BanUser': grpc.unary_unary_rpc_method_handler(
                    servicer.BanUser,
                    request_deserializer=gRPC_dot_tutors__pb2.BanUserRequest.FromString,
                    response_serializer=gRPC_dot_tutors__pb2.Success.SerializeToString,
            ),
    }
...
class UserService(object):
    ...
    def BanUser(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/users.UserService/BanUser',
            gRPC_dot_tutors__pb2.BanUserRequest.SerializeToString,
            gRPC_dot_tutors__pb2.Success.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
